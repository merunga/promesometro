class CommentMailer < ActionMailer::Base
  ...
  def new_comment(comment)
    ...
    mail(:from => 'merunga@gmail.com', :to => emails_for_comment(comment), :subject => I18n.t('muck.comments.new_comment_email_subject', :name => display_name, :application_name => 'promesometro')) do |format|
      format.html
      format.text
    end
  end
